...
var Advepa = function () {
    var e = $(window).width(), t = function () {
        ...
        jQuery(".dlabnav-scroll").length > 0 && new PerfectScrollbar(".dlabnav-scroll")
    }, C = function () {
        ...
        jQuery(".show-pass").on("click", function () {
            ...
            jQuery(this).toggleClass("active"), "password" == jQuery("#dz-old-password").attr("type") ? jQuery("#dz-old-password").attr("type", "text") : "text" == jQuery("#dz-old-password").attr("type") && jQuery("#dz-old-password").attr("type", "password")
        })
    }, x = function () {
        jQuery("#lightgallery, .lightgallery").length > 0 && $("#lightgallery, .lightgallery").lightGallery({thumbnail: !0})
    }, y = function () {
        var e = {
            init: function () {
    ...
    return {
        init: function () {
            t(), n(), a(), l(), o(), s(), c(), i(), r(), d(), u(), h(), f(), p(), m(), g(), b(), v(), w(), C(), k(), x(), y(), z()
        }, load: function () {
            t(), n()
        }, resize: function () {
        }
